...
class ProcessGEF:
    def __init__(self, data_dir='data/GEFCom2014', 
        ...
        self.cov_column = ['U10','V10','U100','V100','WS10','WE10','WD10','WS100','WE100','WD100']
    ...
    def _feature_engineering(self):
        self.data['WS10'] = np.sqrt(self.data['U10'].values ** 2 + self.data['V10'].values ** 2)
        self.data['WE10'] = 0.5 * self.data['WS10']**3
        self.data['WD10'] = (180 / np.pi) * np.arctan(self.data['U10'].values, self.data['V10'].values)
        
        self.data['WS100'] = np.sqrt(self.data['U100'].values ** 2 + self.data['V100'].values ** 2)
        self.data['WE100'] = 0.5 * self.data['WS100']**3
        self.data['WD100'] = (180 / np.pi) * np.arctan(self.data['U100'].values, self.data['V100'].values)
